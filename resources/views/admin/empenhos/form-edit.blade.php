...
<tr>
    ...
    <td style='width: 10%'>{!!Form::date("submateriais[".$subMaterial->material->id."][vencimento]", $subMaterial->vencimento, array('class'=>'form-control valor valor-total-material', 'id' => "submateriais[".$subMaterial->material->id."][vl_total]", 'required' => 'required'))!!}</td>
